...
//public class Test {
//
//    static Services.IDataBase db;
//    static Services.ICrud crud;
//    static Services.IHigherService higher;
//
//    @org.junit.BeforeClass
//    public static void setup() {
//        db = Services.DIContainer.getInjector().getInstance(Services.IDataBase.class);
//        crud = Services.DIContainer.getInjector().getInstance(Services.ICrud.class);
//        higher = Services.DIContainer.getInjector().getInstance(Services.IHigherService.class);
//    }
//
//    @org.junit.Test
...
//        Services.DropDown dropDown = new Services.DropDown();
...
//        Services.Pagination pg = new Services.Pagination();
